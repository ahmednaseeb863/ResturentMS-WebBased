...
class OrderResource extends Resource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'bill_requested_at' => static::iso($order->bill_requested_at),
            'bill_requested_by' => $this->ref('billRequestedBy'),
            ...
            'delivery' => $delivery ? [
                ...
                'zone' => $delivery->relationLoaded('zone') && $delivery->zone ? Resource::refOf($delivery->zone) : null,
                'rider' => $delivery->relationLoaded('rider') && $delivery->rider ? Resource::refOf($delivery->rider, ['name', 'phone']) : null,
                'dispatched' => $delivery->status->isDispatched(),
